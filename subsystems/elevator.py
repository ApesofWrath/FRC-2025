...
class Elevator(commands2.Subsystem):
    def __init__(self) -> None:
        ...
        self.motorConfigs = configs.TalonFXConfiguration()

        self.motorConfigs.motor_output = configs.MotorOutputConfigs() \
            .with_neutral_mode(signals.NeutralModeValue.BRAKE)

        self.motorConfigs.current_limits = configs.CurrentLimitsConfigs() \
            .with_stator_current_limit_enable(True) \
            .with_stator_current_limit(constants.Elevator.currentLimit)

        self.motorConfigs.software_limit_switch = configs.SoftwareLimitSwitchConfigs() \
        ...
        self.motorConfigs.slot0 = configs.Slot0Configs() \
        ...
        self.motorConfigs.motion_magic = configs.MotionMagicConfigs() \
        ...
        self.mainMotor.configurator.apply(self.motorConfigs)
        self.othrMotor.configurator.apply(self.motorConfigs)
